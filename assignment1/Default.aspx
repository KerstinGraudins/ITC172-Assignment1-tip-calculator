...
<body>
    ...
    <div>
       <p>
           ...
           <!-- renamed because I will refer to text box in code-->
           <asp:TextBox ID="MealTextBox" runat="server"></asp:TextBox>
           <asp:RadioButtonList ID="TipPercentsButtons" runat="server"></asp:RadioButtonList><br />
           <asp:TextBox ID="OtherTextBox" runat="server"></asp:TextBox>
           <asp:Button ID="SubmitButton" runat="server" Text="Submit" OnClick="Submit_Click" /><br />
